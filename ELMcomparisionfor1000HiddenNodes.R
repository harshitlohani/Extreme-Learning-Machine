...
plot(comparisionofaccuracy, type = "p", xlim=c(1, 6), ylim=c(-10, 100), 
     main="Performance with Different Activation Functions with 1000 Hidden Nodes", col.main="red",
