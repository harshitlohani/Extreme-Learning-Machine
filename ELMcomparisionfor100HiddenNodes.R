...
plot(comparisionofaccuracy, type = "p", xlim=c(1, 6), ylim=c(-100, 100), 
     main="Performance with Different Activation Functions with 100 Hidden Nodes", col.main="red",
