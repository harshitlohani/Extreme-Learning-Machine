...
plot(comparisionofaccuracy, type = "p", xlim=c(1, 6), ylim=c(0, 100), 
     main="Performance with Different Activation Functions with 300 Hidden Nodes", col.main="red",
